import type { IExecuteFunctions, IHookFunctions, IHttpRequestOptions, ILoadOptionsFunctions, ISupplyDataFunctions } from 'n8n-workflow'
 ...
 */
export async function mem0ApiRequest(this: Ctx, method: string, endpoint: string, body: Record<string, any> = {}, qs: Record<string, any> = {}): Promise<any> {
